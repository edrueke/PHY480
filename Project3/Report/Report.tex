...
The code developed for this project is written in C++ using the ROOT [1] framework for plotting.  Code from [2] and [3] was reused, particularly the \textttt{thevec} and \textttt{themat} classes defined in \textttt{classes.C}.  However, several new classes and functions were designed specifically for the problem of solving the solar system.
...
\begin{center}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/earth_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/earth_vel.png}
\end{subfigure}
...
\begin{center}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/earth_pos_very_long.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/earth_vel_very_long.png}
\end{subfigure}
...
\begin{center}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/earth_pos_long.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/earth_vel_long.png}
\end{subfigure}
...
\begin{center}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/pos_nstep_check_verlet.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/pos_nstep_check_rk4.png}
\end{subfigure} \\
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/vel_nstep_check_verlet.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/vel_nstep_check_rk4.png}
\end{subfigure} 
...
\begin{center}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{benchmarks/kinetic.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{benchmarks/potential.png}
\end{subfigure} \\
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{benchmarks/total_energy.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{benchmarks/angular_mom.png}
\end{subfigure} 
...
\begin{center}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_verlet_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_verlet_vel.png}
\end{subfigure} \\
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_rk4_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_rk4_vel.png}
\end{subfigure} 
...
\begin{center}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_long_verlet_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_long_verlet_vel.png}
\end{subfigure} \\
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_long_rk4_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_long_rk4_vel.png}
\end{subfigure} 
...
\begin{center}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_long_500steps_verlet_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_long_500steps_verlet_vel.png}
\end{subfigure} \\
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_long_500steps_rk4_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_long_500steps_rk4_vel.png}
\end{subfigure} 
...
\begin{center}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter10_only_long_750steps_verlet_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter10_only_long_750steps_verlet_vel.png}
\end{subfigure} \\
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter10_only_long_750steps_rk4_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter10_only_long_750steps_rk4_vel.png}
\end{subfigure} 
...
\begin{center}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter1000_only_long_2000steps_verlet_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter1000_only_long_2000steps_verlet_vel.png}
\end{subfigure} \\
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter1000_only_long_2000steps_rk4_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter1000_only_long_2000steps_rk4_vel.png}
\end{subfigure} 
...
\begin{center}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_com_verlet_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_com_verlet_vel.png}
\end{subfigure} \\
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_com_rk4_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/jupiter_only_com_rk4_vel.png}
\end{subfigure} 
...
\begin{center}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/milky_way_full_100yrs_verlet_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/milky_way_full_100yrs_verlet_vel.png}
\end{subfigure} \\
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/milky_way_full_100yrs_rk4_pos.png}
\end{subfigure}
\begin{subfigure}
\includegraphics[width=0.45\textwidth]{plots/milky_way_full_100yrs_rk4_vel.png}
\end{subfigure} 
